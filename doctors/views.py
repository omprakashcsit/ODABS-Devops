...
def doctor_appointments(request):
    ...
    # Add attendance information for the doctor
    for appointment in appointments:

        appointment.no_show_warning = (
            appointment.no_show_prediction is True
            and not appointment.attendance_confirmed
        )

        appointment.attendance_confirmed_display = (
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if overlap:
                ...
                return render(
                    request,
                    "doctors/add_leave.html",
                    {
                        "error": (
                            "There is already a pending "
                            "or approved leave request for "
                            "the selected dates."
                        ),
                        "form": form
                    }
...
def delete_leave(
    ...
    return render(
        request,
        "doctors/confirm_delete_leave.html",
        {
            "leave": leave
        }
    )
