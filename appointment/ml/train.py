...
# with open("training_dataset_balanced.csv", "r") as file:
...
training_data = pd.read_csv("training_dataset_balanced.csv")
...
Y = training_data["No_Show"].to_numpy(dtype=int)
...
# get the testing target values
Y_test = testing_data["No_Show"].to_numpy(dtype=int)

# normalize testing data using training values
...
for i in range(len(X_test)):
    ...
    prediction = model.predict(X_test[i].tolist())
...
with open("normalization.txt", "w") as file:
    ...
    for i in range(len(min_values)):
        ...
        file.write(str(min_values[i]) + "\n")
        file.write(str(max_values[i]) + "\n")
